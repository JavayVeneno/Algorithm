...
//    }
    ...
    // TODO implements 查找某个元素的ceil(天花板)元素
    private E ceil(Node node, E e) {
        return null;
    }

    public E flower(E e){
        return flower(root,e);
    }
    // TODO implements 查找某个元素的flower(地板)元素
    private E flower(Node node, E e) {
        return null;
    }
    // TODO implements 查找某个元素排第几位
    public int select(E e){
        return 0;
    }
    // TODO implements 查找排第i位的元素
    public E range(int i){
        return null;
    }
